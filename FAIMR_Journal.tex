% =====================================================================
% FAIMR: Journal Extension — Applied Intelligence / JIIS (Springer)
% Extended from FAIMR_SAI.tex (SAI 2026 conference version, 9 pages)
% Target: 16–20 pages
% Document class: article (Overleaf-compatible, no external .cls needed)
% =====================================================================
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textit{Applied Intelligence}}
\fancyhead[R]{\small\textit{FAIMR: Fairness-Aware Resume Ranking}}
\fancyfoot[C]{\thepage}
...
\textbf{Hardware and Runtime.} All experiments were conducted on a standard consumer laptop (Intel Core i7-1260P, 16\,GB RAM) with no GPU. The full pipeline---feature extraction, XGBoost training across 5 folds, evaluation, FCR stress testing, and counterfactual generation for all 8,080 candidates---completes in under 4 minutes wall-clock time. Feature extraction (SBERT encoding of 26,020 pairs) accounts for approximately 60\% of this time; XGBoost training and evaluation account for the remainder. This runtime profile makes FAIMR practically deployable without specialized infrastructure.
