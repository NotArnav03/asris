% =====================================================================
% FAIMR: SAI Conference format (Springer svproc)
% Converted from FAIMR_Springer.tex (llncs) for submission to SAI 2026
% =====================================================================

\documentclass{svproc}

% --- Packages ---
% Removed: \usepackage{amsthm}    -- svproc defines its own theorem environments
%                                    via \spnewtheorem; loading amsthm causes
%                                    "already defined" errors for proof, theorem, etc.
% Removed: \newtheorem{theorem}, {lemma}, {definition}, {proposition}
%                                 -- built-in to svproc; re-declaring causes errors
...
% Custom theorem environment not present in svproc
\spnewtheorem{empiricalobs}{Empirical Observation}{\bfseries}{\itshape}
...
\titlerunning{FAIMR: Fairness-Aware Resume Ranking}

\author{Arnav Gupta\inst{1} \and Dr. Virendrakumar A. Dhotre\inst{1}}

\authorrunning{A. Gupta and V.A. Dhotre}

\tocauthor{Arnav Gupta, Virendrakumar A. Dhotre}

\institute{Department of Computer Science and Engineering (Artificial Intelligence \& Machine Learning),\\
Vishwakarma Institute of Technology Pune\\
(Affiliated to Savitribai Phule Pune University, Pune--411037, Maharashtra, India)\\
\email{arnav.g1010@gmail.com}, \email{virendradhotre@gmail.com}}
